...
if ( ! function_exists( 'celestine_setup' ) ) :
	...
	function celestine_setup() {
		 ...
		 * If you're building a theme based on celestine, use a find and replace
		 * to change 'celestine' to the name of your theme in all the template files.
		 */
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'celestine' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'celestine_custom_background_args', array(
 ...
 */
function celestine_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'celestine_content_width', 640 );
}
add_action( 'after_setup_theme', 'celestine_content_width', 0 );
...
function celestine_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'celestine' ),
		'id'            => 'sidebar-1',
